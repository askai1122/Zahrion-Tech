...
export default function Home() {
  return (
    <PageWrapper>
        ...
        schema={{
          ...
          hasOfferCatalog: {
            ...
            itemListElement: [
              ...
              'POS Software Development', 'CRM Development', 'ERP Development',
              'CMS Development', 'E-Commerce Development', 'Business Management Software',
      ...
      {/* Internal linking hub — spreads crawl equity to industry and city pages */}
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="dark:text-slate-400 text-slate-600 text-sm mb-5 leading-relaxed">
                We already know the workflows, edge cases and compliance rules in these sectors.
              </p>
              <div className="flex flex-wrap gap-2">
                {industries.map(i => (
                  <Link key={i.slug} to={`/industries/${i.slug}`} className="px-3 py-1.5 rounded-lg glass text-xs dark:text-slate-300 text-slate-700 dark:hover:text-brand-400 hover:text-brand-500 transition-colors border dark:border-white/5 border-slate-200">
                    {i.name}
                  </Link>
                ))}
              </div>
