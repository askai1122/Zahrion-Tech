...
import { Globe, Monitor, Smartphone, Terminal, ShoppingCart, Layers, Building2, Share2, UserCheck, Wrench, CheckCircle2, ArrowRight } from 'lucide-react'
...
const services = [
  ...
  },
  {
    ...
    desc: 'Django and Flask web applications, automation scripts, and data-driven backends — built for startups and small businesses that need reliable Python engineering.',
    features: ['Django & Flask apps', 'Automation & scripting', 'REST API development', 'Data pipelines', 'Database design', 'Cloud deployment'],
  ...
  },
  {
    ...
    desc: 'Custom point-of-sale and billing systems for retail, restaurants, pharmacies, and supermarkets — built around your exact workflow.',
    features: ['Retail & restaurant POS', 'Pharmacy & supermarket POS', 'Inventory & billing sync', 'Multi-location support', 'Sales reporting dashboards', 'Barcode & receipt printing'],
  ...
  },
  {
    ...
    color: 'from-brand-500 to-cyan-400',
    desc: 'Custom CRM and ERP systems for customer management, inventory, accounting, and operations — replacing spreadsheets and rigid off-the-shelf tools.',
    features: ['Custom CRM pipelines', 'ERP inventory & HR modules', 'Accounting & invoicing', 'Appointment & booking tools', 'Role-based access', 'Custom dashboards'],
  ...
  },
  {
    ...
    color: 'from-emerald-500 to-teal-400',
    desc: 'Management systems for schools, hospitals, clinics, hotels, and warehouses — tailored to how your organization actually operates.',
    features: ['School management systems', 'Hospital & clinic software', 'Hotel booking management', 'Warehouse & distribution', 'Data migration', 'Staff training & support'],
