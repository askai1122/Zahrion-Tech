...
const links = {
  ...
  Services: [
    ...
    { to: '/hire-python-developer', label: 'Hire a Python Developer' },
    { to: '/hire-software-developer', label: 'Hire a Software Developer' },
  ],
  Industries: [
    { to: '/industries', label: 'All Industries' },
    { to: '/industries/restaurant-pos-software', label: 'Restaurant POS Software' },
    { to: '/industries/retail-pos-software', label: 'Retail POS & Inventory' },
    { to: '/industries/crm-software-development', label: 'Custom CRM Development' },
    { to: '/industries/erp-software-development', label: 'Custom ERP Development' },
    { to: '/industries/cms-development', label: 'Custom CMS Development' },
...
const socialLinks = [
  ...
  { icon: Mail, href: 'mailto:support@zahriontech.com' },
]
